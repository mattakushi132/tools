...
class ColorConverter(QMainWindow):
    def __init__(self):
        ...
        layout.addWidget(self.preview_color_label, 0,3, 6,1)
        layout.addWidget(self.label_convert_to, 2,0)
        layout.addWidget(self.converted_color_label, 2,1)
        layout.addWidget(copy_button, 3,0, 3,2)
